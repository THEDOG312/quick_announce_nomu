...
ENV = {
        FORMATS = {
            ...
            NAMED_THIS_SINGLE = '这里有 1个 {PREFAB_NAME}，其中这个名为 {NAME}{SHOW_ME}{DISTANCE}。',

            CODE = '名称：{NAME}，代码：{PREFAB}{MOD_INFO}{ASSET_INFO}',
            
            FISH_SHOAL = '这里有群 {FISH}，共有 {NUM}条 {FISH}{SHOW_ME}{DISTANCE}！',

            STATE_EQUAL = '这里有 {TOTAL}个 {NAME}，其中全都{ADJ}{SHOW_ME}{DISTANCE}。',
            ...
            STORAGE_EMPTY_THIS = '这里有 {TOTAL}个 {NAME}，其中这个是空的{SHOW_ME}{DISTANCE}。',
            STORAGE_EMPTY_THIS_SINGLE = '这里有 1个 {NAME}，其中这个是空的{SHOW_ME}{DISTANCE}。',
            STORAGE_EMPTY_EQUAL = '这里有 {TOTAL}个 {NAME}，其中全都是空的{SHOW_ME}{DISTANCE}。',
        },
        MAPPINGS = {
            DEFAULT = {
                WORDS = {
                ...
                ADJ = {
                    ...
                    BIRDCAGE_EMPTY = '空空的',
                    BIRDCAGE_FULL = '关着小鸟',
                    BIRDCAGE_SICK = '里的鸟生病了',
                    BIRDCAGE_DEAD = '里的鸟饿死了',
